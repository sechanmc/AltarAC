...
public class MovementTickerStrider extends MovementTickerRideable {
    ...
    public MovementTickerStrider(AltarACPlayer player) {
        super(player);
        this.movementInput = Input.createInput(player, 0, 0, 1);
    }

    public static void floatStrider(AltarACPlayer player) {
    ...
    public static boolean isAbove(AltarACPlayer player) {
