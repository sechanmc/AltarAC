...
import ac.altarac.predictionengine.movementtick.MovementTickerPlayer;
...
import ac.altarac.utils.data.KnownInput;
...
import ac.altarac.utils.nmsutil.JumpPower;
import ac.altarac.utils.nmsutil.Riptide;
...
public class PredictionEngine {
    ...
    public static Vector3dm clampMovementToHardBorder(AltarACPlayer player, Vector3dm outputVel) {
        // TODO: Reimplement
        return outputVel;
    }

    public void guessBestMovement(float speed, AltarACPlayer player) {
    ...
    private void doPredictions(AltarACPlayer player, List<VectorData> possibleVelocities, float speed) {
    ...
    private Pair<Vector3dm, Vector3dm> doSeekingWallCollisions(AltarACPlayer player, Vector3dm primaryPushMovement, Vector3dm originalClientVel, VectorData clientVelAfterInput) {
    ...
    private void addZeroPointThreeToPossibilities(float speed, AltarACPlayer player, List<VectorData> possibleVelocities) {
    ...
    public void addFluidPushingToStartingVectors(AltarACPlayer player, Set<VectorData> data) {
    ...
    public Set<VectorData> fetchPossibleStartTickVectors(AltarACPlayer player) {
        ...
        // Inputs are done AFTER fluid pushing, https://github.com/MWHunter/AltarAC/issues/660
    ...
    private void addNonEffectiveAI(AltarACPlayer player, Set<VectorData> data) {
    ...
    private void addAttackSlowToPossibilities(AltarACPlayer player, Set<VectorData> velocities) {
    ...
    public void applyMovementThreshold(AltarACPlayer player, Set<VectorData> velocities) {
    ...
    public void addExplosionToPossibilities(AltarACPlayer player, Set<VectorData> existingVelocities) {
    ...
    public int sortVectorData(VectorData a, VectorData b, AltarACPlayer player) {
        int aScore = 0;
        int bScore = 0;
    ...
    public Vector3dm handleStartingVelocityUncertainty(AltarACPlayer player, VectorData vector, Vector3dm targetVec) {
        ...
        // https://github.com/MWHunter/AltarAC/issues/398
        ...
        //
        //
        // AltarAC's old solution with hard lerping entities was to just give a ton of direct offset reduction
    ...
    public void endOfTick(AltarACPlayer player, double d) {
        player.canSwimHop = canSwimHop(player);
        player.lastWasClimbing = 0;
    }

    private void loopVectors(AltarACPlayer player, Set<VectorData> possibleVectors, float speed, List<VectorData> returnVectors) {
        // Stop omni-sprint
    ...
    public boolean canSwimHop(AltarACPlayer player) {
    ...
    public Vector3dm handleOnClimbable(Vector3dm vector, AltarACPlayer player) {
        return vector;
    }

    public void doJump(AltarACPlayer player, Vector3dm vector) {
