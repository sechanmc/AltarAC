...
public class PredictionEngineElytra extends PredictionEngine {
    public static Vector3dm getElytraMovement(AltarACPlayer player, Vector3dm vector, Vector3dm lookVector) {
        float pitchRadians = AltarACMath.radians(player.pitch);
        ...
        // Yeah, slow falling needs a refactor in AltarAC.
