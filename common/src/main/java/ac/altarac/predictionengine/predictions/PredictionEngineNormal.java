...
public class PredictionEngineNormal extends PredictionEngine {
    ...
    public static void staticVectorEndOfTick(AltarACPlayer player, Vector3dm vector) {
    ...
    public Vector3dm handleOnClimbable(Vector3dm vector, AltarACPlayer player) {
        if (player.isClimbing) {
            ...
            vector.setX(AltarACMath.clamp(vector.getX(), -0.15F, 0.15F));
            vector.setZ(AltarACMath.clamp(vector.getZ(), -0.15F, 0.15F));
