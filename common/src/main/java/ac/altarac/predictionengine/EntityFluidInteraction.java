...
public class EntityFluidInteraction {
    ...
    public void update(final AltarACPlayer player, final boolean ignoreCurrent) {
        ...
        int minX = AltarACMath.floor(aabb.minX);
        int minY = AltarACMath.floor(aabb.minY);
        int minZ = AltarACMath.floor(aabb.minZ);
        int maxX = AltarACMath.ceil(aabb.maxX) - 1;
        int maxY = AltarACMath.ceil(aabb.maxY) - 1;
        int maxZ = AltarACMath.ceil(aabb.maxZ) - 1;
        ...
        int playerX = AltarACMath.floor(player.lastX);
        double playerEyeY = player.lastY + player.getEyeHeight() - 0.1111111119389534D;
        int playerZ = AltarACMath.floor(player.lastZ);
    ...
    public void applyCurrentTo(final FluidTag fluid, final AltarACPlayer entity, final double scale) {
    ...
    private static class Tracker {
        ...
        public void applyCurrentTo(final AltarACPlayer player, final double scale) {
