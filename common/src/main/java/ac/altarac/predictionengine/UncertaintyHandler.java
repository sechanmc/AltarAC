...
import ac.altarac.utils.data.LastInstance;
...
public class UncertaintyHandler {
    ...
    public UncertaintyHandler(AltarACPlayer player) {
        this.player = player;
    ...
    public double reduceOffset(double offset) {
        ...
        // This is a section where I hack around current issues with AltarAC itself...
