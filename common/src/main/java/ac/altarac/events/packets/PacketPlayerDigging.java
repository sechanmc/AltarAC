...
import ac.altarac.utils.item.ItemBehaviour;
import ac.altarac.utils.item.ItemBehaviourRegistry;
...
public class PacketPlayerDigging extends PacketListenerAbstract {
    ...
    public static void handleUseItem(@NotNull AltarACPlayer player, @NotNull InteractionHand hand) {
    ...
    public void onPacketReceive(PacketReceiveEvent event) {
        ...
        if (event.getPacketType() == PacketType.Play.Client.HELD_ITEM_CHANGE) {
            ...
            if (player.packetStateData.lastSlotSelected != slot) {
                if (player.isResetItemUsageOnSlotChange() && AltarACAPI.INSTANCE.getItemResetHandler().getItemUsageHand(player.platformPlayer) == InteractionHand.MAIN_HAND) {
