...
public class PacketWorldReaderEight extends BasePacketWorldReader {
    @Override
    public void handleMapChunkBulk(final AltarACPlayer player, final PacketSendEvent event) {
    ...
    @Override
    public void handleMapChunk(final AltarACPlayer player, final PacketSendEvent event) {
        PacketWrapper<?> wrapper = new PacketWrapper<>(event);
