...
import ac.altarac.utils.worldborder.BorderExtent;
import ac.altarac.utils.worldborder.RealTimeMovingBorderExtent;
import ac.altarac.utils.worldborder.StaticBorderExtent;
import ac.altarac.utils.worldborder.TickBasedMovingBorderExtent;
...
public class PacketWorldBorder extends Check implements PacketCheck {
    ...
    public PacketWorldBorder(AltarACPlayer playerData) {
        super(playerData);
