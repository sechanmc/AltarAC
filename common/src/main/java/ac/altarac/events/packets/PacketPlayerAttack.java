...
import ac.altarac.checks.impl.badpackets.BadPacketsW;
...
public class PacketPlayerAttack extends PacketListenerAbstract {
    ...
    private void onAttack(PacketReceiveEvent event, AltarACPlayer player, int entityId) {
        if (isInvalidEntity(event, player, entityId)) return;
    ...
    private boolean isInvalidEntity(PacketReceiveEvent event, AltarACPlayer player, int entityId) {
