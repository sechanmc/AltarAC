...
import ac.altarac.checks.impl.elytra.ElytraC;
...
public class PacketPlayerRespawn extends PacketListenerAbstract {
    ...
    public void onPacketSend(PacketSendEvent event) {
        ...
        if (event.getPacketType() == PacketType.Play.Server.RESPAWN) {
            ...
            player.addRealTimeTaskNext(() -> {
                ...
                if (!AltarACAPI.INSTANCE.getSpectateManager().isSpectating(player.uuid)) {
    ...
    private boolean isWorldChange(AltarACPlayer player, WrapperPlayServerRespawn respawn) {
