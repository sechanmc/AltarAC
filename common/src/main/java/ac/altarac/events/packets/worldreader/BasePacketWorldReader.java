package ac.altarac.events.packets.worldreader;

import ac.altarac.AltarACAPI;
import ac.altarac.player.AltarACPlayer;
import ac.altarac.utils.chunks.Column;
import ac.altarac.utils.data.TeleportData;
...
public class BasePacketWorldReader extends PacketListenerAbstract {
    ...
    public void handleMapChunkBulk(AltarACPlayer player, PacketSendEvent event) {
    ...
    public void handleMapChunk(AltarACPlayer player, PacketSendEvent event) {
    ...
    public void addChunkToCache(PacketSendEvent event, AltarACPlayer player, BaseChunk[] chunks, boolean isGroundUp, int chunkX, int chunkZ) {
    ...
    public void unloadChunk(AltarACPlayer player, int x, int z) {
        if (player == null) return;
        player.compensatedWorld.removeChunkLater(x, z);
    }

    public void handleBlockChange(AltarACPlayer player, PacketSendEvent event) {
    ...
    public void handleMultiBlockChange(AltarACPlayer player, PacketSendEvent event) {
