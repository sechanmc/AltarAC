...
public interface AsyncScheduler {
     ...
     */
    TaskHandle runNow(@NotNull AltarACPlugin plugin, @NotNull Runnable task);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle runDelayed(@NotNull AltarACPlugin plugin, @NotNull Runnable task, long delay, @NotNull TimeUnit timeUnit);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle runAtFixedRate(@NotNull AltarACPlugin plugin, @NotNull Runnable task, long delay, long period, @NotNull TimeUnit timeUnit);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle runAtFixedRate(@NotNull AltarACPlugin plugin, @NotNull Runnable task, long initialDelayTicks, long periodTicks);
     ...
     */
    void cancel(@NotNull AltarACPlugin plugin);
}
