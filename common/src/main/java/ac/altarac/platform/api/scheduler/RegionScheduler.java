...
package ac.altarac.platform.api.scheduler;
...
public interface RegionScheduler {
     ...
     */
    void execute(@NotNull AltarACPlugin plugin, @NotNull PlatformWorld world, int chunkX, int chunkZ, @NotNull Runnable task);
     ...
     * @param task     The task to execute
     */
    void execute(@NotNull AltarACPlugin plugin, @NotNull Location location, @NotNull Runnable task);
     ...
     */
    TaskHandle run(@NotNull AltarACPlugin plugin, @NotNull PlatformWorld world, int chunkX, int chunkZ, @NotNull Runnable task);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle run(@NotNull AltarACPlugin plugin, @NotNull Location location, @NotNull Runnable task);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle runDelayed(@NotNull AltarACPlugin plugin, @NotNull PlatformWorld world, int chunkX, int chunkZ, @NotNull Runnable task, long delayTicks);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle runDelayed(@NotNull AltarACPlugin plugin, @NotNull Location location, @NotNull Runnable task, long delayTicks);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle runAtFixedRate(@NotNull AltarACPlugin plugin, @NotNull PlatformWorld world, int chunkX, int chunkZ, @NotNull Runnable task, long initialDelayTicks, long periodTicks);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle runAtFixedRate(@NotNull AltarACPlugin plugin, @NotNull Location location, @NotNull Runnable task, long initialDelayTicks, long periodTicks);
}
