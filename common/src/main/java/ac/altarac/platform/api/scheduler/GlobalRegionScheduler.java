...
public interface GlobalRegionScheduler {
     ...
     */
    void execute(@NotNull AltarACPlugin plugin, @NotNull Runnable task);
     ...
     */
    TaskHandle run(@NotNull AltarACPlugin plugin, @NotNull Runnable task);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle runDelayed(@NotNull AltarACPlugin plugin, @NotNull Runnable task, long delay);
