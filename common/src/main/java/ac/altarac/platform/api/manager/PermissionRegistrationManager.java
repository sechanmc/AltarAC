...
public interface PermissionRegistrationManager {
     ...
     * dynamic permissions (e.g., check-specific permissions like "AltarAC.exempt.checkname")
     * are available for autocomplete before AltarAC attempts to use them. This is
     ...
     *
     * @param name         The permission node to register (e.g., "AltarAC.exempt").
