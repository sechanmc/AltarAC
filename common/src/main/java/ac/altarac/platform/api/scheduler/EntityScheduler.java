...
public interface EntityScheduler {
     ...
     */
    void execute(@NotNull AltarACEntity entity, @NotNull AltarACPlugin plugin, @NotNull Runnable run, @Nullable Runnable retired, long delay);
     ...
     */
    TaskHandle run(@NotNull AltarACEntity entity, @NotNull AltarACPlugin plugin, @NotNull Runnable task, @Nullable Runnable retired);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle runDelayed(@NotNull AltarACEntity entity, @NotNull AltarACPlugin plugin, @NotNull Runnable task, @Nullable Runnable retired, long delayTicks);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle runAtFixedRate(@NotNull AltarACEntity entity, @NotNull AltarACPlugin plugin, @NotNull Runnable task, @Nullable Runnable retired, long initialDelayTicks, long periodTicks);
}
