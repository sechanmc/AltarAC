...
public class BaseConfigManager {
    ...
    @Getter
    private String prefix = "<gray>[<gradient:#FB0000:#FF874C><b>AltarAC</gradient><gray>]";
    @Getter
    ...
    public void load(ConfigManager config) {
        ...
        prefix = config.getStringElse("prefix", "<gray>[<gradient:#FB0000:#FF874C><b>AltarAC</gradient><gray>]");
