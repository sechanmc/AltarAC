package ac.altarac.manager.player.handlers;
...
public record DefaultResyncHandler(AltarACPlayer player) implements ResyncHandler {

    private static void resyncPositions(AltarACPlayer player, int minBlockX, int mY, int minBlockZ, int maxBlockX, int mxY, int maxBlockZ) {
        ...
        AltarACAPI.INSTANCE.getScheduler().getRegionScheduler().execute(AltarACAPI.INSTANCE.getPlugin(), world,
    ...
    private static void resyncPosition(AltarACPlayer player, int x, int y, int z, int sequence) {
        if (player.platformPlayer == null) return;
        ...
        AltarACAPI.INSTANCE.getScheduler().getRegionScheduler().execute(AltarACAPI.INSTANCE.getPlugin(), world, chunkX, chunkZ, () -> {
