// This file was designed and is an original check for AltarAC
...
import ac.altarac.utils.data.ReachInterpolationData;
import ac.altarac.utils.data.TrackedPosition;
...
public class PacketEntity extends TypedPacketEntity {
    ...
    public PacketEntity(AltarACPlayer player, EntityType type) {
        super(type);
        this.uuid = null;
    ...
    public PacketEntity(AltarACPlayer player, UUID uuid, EntityType type, double x, double y, double z) {
        super(type);
        this.uuid = uuid;
        initAttributes(player);
        this.trackedServerPosition = new TrackedPosition();
    ...
    protected void initAttributes(AltarACPlayer player) {
    ...
    public void onFirstTransaction(boolean relative, boolean hasPos, double relX, double relY, double relZ, AltarACPlayer player) {
        if (hasPos) {
            if (relative) {
    ...
    public void setPositionRaw(AltarACPlayer player, SimpleCollisionBox box) {
