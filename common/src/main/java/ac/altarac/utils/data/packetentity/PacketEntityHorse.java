...
public class PacketEntityHorse extends PacketEntityTrackXRot implements JumpableEntity {
    ...
    public PacketEntityHorse(AltarACPlayer player, UUID uuid, EntityType type, double x, double y, double z, float xRot) {
    ...
    @Override
    public boolean canPlayerJump(AltarACPlayer player) {
        return this.hasSaddle();
    }

    @Override
    public void executeJump(AltarACPlayer player, Set<VectorData> possibleVectors) {
        ...
        float yawRadians = AltarACMath.radians(player.yaw);
