// This file was designed and is an original check for AltarACBukkitLoaderPlugin
...
public class ReachInterpolationData {
    ...
    public ReachInterpolationData(AltarACPlayer player, SimpleCollisionBox startingLocation, TrackedPosition position, PacketEntity entity) {
    ...
    public ReachInterpolationData(AltarACPlayer player, SimpleCollisionBox finishedLoc, PacketEntity entity) {
    ...
    public void updatePossibleStartingLocation(SimpleCollisionBox possibleLocationCombined) {
        //AltarACBukkitLoaderPlugin.staticGetLogger().info(ChatColor.BLUE + "Updated new starting location as second trans hasn't arrived " + startingLocation);
        this.startingLocation = combineCollisionBox(startingLocation, possibleLocationCombined);
        //AltarACBukkitLoaderPlugin.staticGetLogger().info(ChatColor.BLUE + "Finished updating new starting location as second trans hasn't arrived " + startingLocation);
    }
