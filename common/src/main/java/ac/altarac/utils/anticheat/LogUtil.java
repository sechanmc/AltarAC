...
public class LogUtil {
    ...
    public Logger getLogger() {
        return AltarACAPI.INSTANCE.getPlugin().getLogger();
    }

    public void console(final String info) {
        AltarACAPI.INSTANCE.getPlatformServer().getConsoleSender().sendMessage(MessageUtil.translateAlternateColorCodes('&', info));
    }

    public void console(final Component info) {
        AltarACAPI.INSTANCE.getPlatformServer().getConsoleSender().sendMessage(info);
    }
