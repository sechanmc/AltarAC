...
import ac.altarac.utils.inventory.EquipmentType;
...
import ac.altarac.utils.inventory.inventory.NotImplementedMenu;
...
public class CompensatedInventory extends Check implements PacketCheck {
    ...
    public CompensatedInventory(AltarACPlayer playerData) {
        super(playerData);
