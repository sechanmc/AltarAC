package ac.altarac.utils.latency;
...
import ac.altarac.utils.data.BlockPrediction;
import ac.altarac.utils.data.Pair;
import ac.altarac.utils.data.PistonData;
import ac.altarac.utils.data.ShulkerData;
import ac.altarac.utils.data.packetentity.PacketEntity;
import ac.altarac.utils.data.packetentity.PacketEntityShulker;
...
public class CompensatedWorld implements PacketWorld {
    ...
    public CompensatedWorld(AltarACPlayer player) {
        this.player = player;
    ...
    public float getWaterFluidLevelAt(double x, double y, double z) {
        return getWaterFluidLevelAt(AltarACMath.floor(x), AltarACMath.floor(y), AltarACMath.floor(z));
    }
