...
public class Slot {
    ...
    public ItemStack safeTake(int p_150648_, int p_150649_, AltarACPlayer p_150650_) {
    ...
    public Optional<ItemStack> tryRemove(int p_150642_, int p_150643_, AltarACPlayer player) {
    ...
    // No override
    public boolean allowModification(AltarACPlayer player) {
        return this.mayPickup(player) && this.mayPlace(this.getItem());
    }

    public boolean mayPickup(AltarACPlayer player) {
        return true;
    }
}
