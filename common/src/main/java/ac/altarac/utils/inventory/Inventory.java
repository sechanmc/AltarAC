package ac.altarac.utils.inventory;

import ac.altarac.player.AltarACPlayer;
import ac.altarac.utils.inventory.inventory.AbstractContainerMenu;
import ac.altarac.utils.inventory.slot.EquipmentSlot;
import ac.altarac.utils.inventory.slot.ResultSlot;
import ac.altarac.utils.inventory.slot.Slot;
import ac.altarac.utils.lists.CorrectingPlayerInventoryStorage;
...
public class Inventory extends AbstractContainerMenu {
    ...
    public Inventory(AltarACPlayer player, CorrectingPlayerInventoryStorage inventoryStorage) {
        super(player);
