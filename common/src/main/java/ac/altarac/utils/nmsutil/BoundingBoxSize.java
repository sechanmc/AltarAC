...
import ac.altarac.utils.data.packetentity.*;
...
public final class BoundingBoxSize {
    ...
    public static float getWidth(AltarACPlayer player, PacketEntity packetEntity) {
    ...
    private static float getWidthMinusBaby(AltarACPlayer player, PacketEntity packetEntity) {
    ...
    public static Vector3d getRidingOffsetFromVehicle(PacketEntity entity, AltarACPlayer player) {
        ...
        if (entity instanceof PacketEntityTrackXRot xRotEntity) {
            ...
            if (EntityTypes.isTypeInstanceOf(entity.getType(), EntityTypes.BOAT)) {
                ...
                vec3 = yRot(AltarACMath.radians(-xRotEntity.interpYaw) - ((float) Math.PI / 2f), vec3);
                return new Vector3d(x + vec3.x, y + (double) f1, z + vec3.z);
            } else if (entity.getType() == EntityTypes.LLAMA) {
                float f = player.trigHandler.cos(AltarACMath.radians(xRotEntity.interpYaw));
                float f1 = player.trigHandler.sin(AltarACMath.radians(xRotEntity.interpYaw));
                ...
                float f = player.trigHandler.sin(AltarACMath.radians(xRotEntity.interpYaw));
                float f1 = player.trigHandler.cos(AltarACMath.radians(xRotEntity.interpYaw));
    ...
    public static float getHeight(AltarACPlayer player, PacketEntity packetEntity) {
    ...
    public static double getPassengerRidingOffset(AltarACPlayer player, PacketEntity packetEntity) {
    ...
    private static float getHeightMinusBaby(AltarACPlayer player, PacketEntity packetEntity) {
        final EntityType type = packetEntity.getType();
    ...
    private static float getBabyScaleFactor(AltarACPlayer player, PacketEntity packetEntity) {
        final EntityType type = packetEntity.getType();
