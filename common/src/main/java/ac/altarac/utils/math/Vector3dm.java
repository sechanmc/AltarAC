...
public class Vector3dm implements Cloneable, Serializable {
    ...
    public double length() {
        return Math.sqrt(AltarACMath.square(this.x) + AltarACMath.square(this.y) + AltarACMath.square(this.z));
    }

    public double lengthSquared() {
        return AltarACMath.square(this.x) + AltarACMath.square(this.y) + AltarACMath.square(this.z);
    }
    ...
    public double distanceSquared(double oX, double oY, double oZ) {
        return AltarACMath.square(this.x - oX) + AltarACMath.square(this.y - oY) + AltarACMath.square(this.z - oZ);
    }
    ...
    public boolean isInSphere(@NotNull Vector3dm origin, double radius) {
        return AltarACMath.square(origin.x - this.x) + AltarACMath.square(origin.y - this.y) + AltarACMath.square(origin.z - this.z) <= AltarACMath.square(radius);
    }
    ...
    public int getBlockX() {
        return AltarACMath.mojangFloor(this.x);
    }
    ...
    public int getBlockY() {
        return AltarACMath.mojangFloor(this.y);
    }
    ...
    public int getBlockZ() {
        return AltarACMath.mojangFloor(this.z);
    }
