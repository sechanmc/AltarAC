...
public class DynamicChorusPlant implements CollisionFactory {
    ...
    public CollisionBox getLegacyBoundingBox(AltarACPlayer player, ClientVersion version, int x, int y, int z) {
    ...
    public Set<BlockFace> getLegacyStates(AltarACPlayer player, ClientVersion version, int x, int y, int z) {
