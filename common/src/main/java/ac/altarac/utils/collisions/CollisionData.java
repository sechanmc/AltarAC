package ac.altarac.utils.collisions;
...
import ac.altarac.utils.collisions.blocks.DynamicChest;
import ac.altarac.utils.collisions.blocks.DynamicChorusPlant;
import ac.altarac.utils.collisions.blocks.DynamicStair;
import ac.altarac.utils.collisions.blocks.PistonBaseCollision;
import ac.altarac.utils.collisions.blocks.PistonHeadCollision;
import ac.altarac.utils.collisions.blocks.TrapDoorHandler;
import ac.altarac.utils.collisions.blocks.connecting.DynamicCollisionFence;
import ac.altarac.utils.collisions.blocks.connecting.DynamicCollisionPane;
import ac.altarac.utils.collisions.blocks.connecting.DynamicCollisionWall;
import ac.altarac.utils.collisions.datatypes.CollisionBox;
import ac.altarac.utils.collisions.datatypes.CollisionFactory;
import ac.altarac.utils.collisions.datatypes.ComplexCollisionBox;
import ac.altarac.utils.collisions.datatypes.DynamicCollisionBox;
import ac.altarac.utils.collisions.datatypes.HexCollisionBox;
import ac.altarac.utils.collisions.datatypes.HexOffsetCollisionBox;
import ac.altarac.utils.collisions.datatypes.NoCollisionBox;
...
public enum CollisionData implements CollisionFactory {
    ...
    public CollisionBox getMovementCollisionBox(AltarACPlayer player, ClientVersion version, WrappedBlockState block, int x, int y, int z) {
        return fetch(player, version, block, x, y, z).offset(x, y, z);
    }

    public CollisionBox getMovementCollisionBox(AltarACPlayer player, ClientVersion version, WrappedBlockState block) {
        if (this.box != null)
