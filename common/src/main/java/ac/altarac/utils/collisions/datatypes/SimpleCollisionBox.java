...
public class SimpleCollisionBox implements CollisionBox {
    ...
    public Vector3d getCenter() {
        return new Vector3d(AltarACMath.lerp(0.5, this.minX, this.maxX), AltarACMath.lerp(0.5, this.minY, this.maxY), AltarACMath.lerp(0.5, this.minZ, this.maxZ));
    }
    ...
    public static Vector3i containing(double x, double y, double z) {
        return new Vector3i(AltarACMath.floor(x), AltarACMath.floor(y), AltarACMath.floor(z));
    }
    ...
    public static Iterable<Vector3i> betweenCornersInDirection(SimpleCollisionBox boundingBox, Vector3d directionVector) {
        int minX = AltarACMath.floor(boundingBox.minX);
        int minY = AltarACMath.floor(boundingBox.minY);
        int minZ = AltarACMath.floor(boundingBox.minZ);
        int maxX = AltarACMath.floor(boundingBox.maxX);
        int maxY = AltarACMath.floor(boundingBox.maxY);
        int maxZ = AltarACMath.floor(boundingBox.maxZ);
