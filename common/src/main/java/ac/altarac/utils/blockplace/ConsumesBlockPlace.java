...
import ac.altarac.utils.collisions.AxisUtil;
...
public class ConsumesBlockPlace {
    public static boolean consumesPlace(@NotNull AltarACPlayer player, @NotNull WrappedBlockState state, @NotNull BlockPlace place) {
