...
@CheckData(name = "FabricatedPlace", stableKey = "AltarAC.scaffolding.fabricated_place", description = "Sent out of bounds cursor position")
public class FabricatedPlace extends BlockPlaceCheck {
    ...
    public FabricatedPlace(AltarACPlayer player) {
        super(player);
    }
