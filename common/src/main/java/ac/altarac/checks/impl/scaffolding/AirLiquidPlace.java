...
@CheckData(name = "AirLiquidPlace", stableKey = "AltarAC.scaffolding.air_liquid_place", description = "Placed a block against an invalid support")
public class AirLiquidPlace extends BlockPlaceCheck {
    public AirLiquidPlace(AltarACPlayer player) {
        super(player);
    }
    ...
    public void onBlockPlace(final BlockPlace place) {
        ...
        int currentTick = AltarACAPI.INSTANCE.getTickManager().currentTick;
