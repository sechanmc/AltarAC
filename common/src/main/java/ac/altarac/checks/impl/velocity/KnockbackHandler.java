package ac.altarac.checks.impl.velocity;
...
@CheckData(name = "AntiKB", stableKey = "AltarAC.velocity.anti_knockback", alternativeName = "AntiKnockback", configName = "Knockback", description = "Did not take the expected entity knockback", setback = 10, decay = 0.025)
public class KnockbackHandler extends Check implements PostPredictionCheck {
    ...
    public KnockbackHandler(AltarACPlayer player) {
        super(player);
    }
