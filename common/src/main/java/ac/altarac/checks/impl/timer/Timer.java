...
@CheckData(name = "Timer", stableKey = "AltarAC.timer.timer", configName = "TimerA", description = "The players game is running faster than normal", setback = 10)
public class Timer extends Check implements PacketCheck {
    ...
    public Timer(AltarACPlayer player) {
        super(player);
    }
