...
@CheckData(name = "AirLiquidBreak", stableKey = "AltarAC.breaking.air_liquid_break", description = "Breaking a block that cannot be broken")
public class AirLiquidBreak extends Check implements BlockBreakCheck {
    ...
    public AirLiquidBreak(AltarACPlayer player) {
        super(player);
    }
    ...
    public void onBlockBreak(BlockBreak blockBreak) {
        ...
        int newTick = AltarACAPI.INSTANCE.getTickManager().currentTick;
        if (lastTick == newTick
