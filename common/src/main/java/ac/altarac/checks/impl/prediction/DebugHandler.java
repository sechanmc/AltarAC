...
import ac.altarac.checks.debug.AbstractDebugHandler;
...
public class DebugHandler extends AbstractDebugHandler implements PostPredictionCheck {
    ...
    private final Set<AltarACPlayer> listeners = new CopyOnWriteArraySet<>(new HashSet<>());
    ...
    public DebugHandler(AltarACPlayer player) {
        super(player);
    }
    ...
    public void onPredictionComplete(final PredictionComplete predictionComplete) {
        ...
        for (AltarACPlayer listener : listeners) {
        ...
        if (outputToConsole) {
            Sender consoleSender = AltarACAPI.INSTANCE.getPlatformServer().getConsoleSender();
    ...
    @Override
    public void toggleListener(AltarACPlayer player) {
