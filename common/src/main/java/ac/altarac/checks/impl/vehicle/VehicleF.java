...
@CheckData(name = "VehicleF", stableKey = "AltarAC.vehicle.boat_input_mismatch", experimental = true, description = "Sent incorrect boat paddle states")
public class VehicleF extends Check implements PacketCheck {
    private static final Verbose V =
            Verbose.of("sent=({bool}, {bool}), expected=({bool}, {bool})");

    public VehicleF(AltarACPlayer player) {
        super(player);
    }
