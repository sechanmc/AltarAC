...
@CheckData(name = "RotationPlace", stableKey = "AltarAC.scaffolding.rotation_place", description = "Placed a block while not looking at it")
public class RotationPlace extends BlockPlaceCheck {
    ...
    public RotationPlace(AltarACPlayer player) {
        super(player);
    }
