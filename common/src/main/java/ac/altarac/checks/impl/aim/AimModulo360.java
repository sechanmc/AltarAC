...
@CheckData(name = "AimModulo360", stableKey = "AltarAC.aim.modulo_360", description = "Sent a large yaw snap", decay = 0.005)
public class AimModulo360 extends Check implements RotationCheck {

    private float lastDeltaYaw;

    public AimModulo360(AltarACPlayer playerData) {
        super(playerData);
    }
