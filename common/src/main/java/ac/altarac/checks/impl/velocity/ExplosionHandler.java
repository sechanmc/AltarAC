...
@CheckData(name = "AntiExplosion", stableKey = "AltarAC.velocity.anti_explosion", configName = "Explosion", description = "Did not take the expected explosion knockback", setback = 10)
public class ExplosionHandler extends Check implements PostPredictionCheck {
    ...
    public ExplosionHandler(AltarACPlayer player) {
        super(player);
    }
