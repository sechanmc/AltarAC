...
@CheckData(name = "Post", stableKey = "AltarAC.post.invalid_order", description = "Sent packets out of the expected movement tick order")
public class Post extends Check implements PacketCheck, PostPredictionCheck {
    ...
    public Post(AltarACPlayer playerData) {
        super(playerData);
    }
    ...
    public void onPacketReceive(final PacketReceiveEvent event) {
        ...
        if (PLAYER_ABILITIES.equals(packetType)
            ...
            // https://github.com/AltarAC/AltarAC/issues/824
