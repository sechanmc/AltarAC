...
@CheckData(name = "TimerLimit", stableKey = "AltarAC.timer.limit", description = "The player has sent too many packets after high latency", setback = 10)
public class TimerLimit extends Timer {
    ...
    public TimerLimit(AltarACPlayer player) {
        super(player);
    }
