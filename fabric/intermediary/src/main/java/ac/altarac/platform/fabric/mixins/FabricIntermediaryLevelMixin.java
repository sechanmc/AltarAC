...
import ac.altarac.platform.fabric.utils.world.FabricIntermediaryLevelChunkUtil;
...
abstract class FabricIntermediaryLevelMixin implements LevelAccessor {
    ...
    public boolean AltarAC$isLoaded() {
        return AltarACFabricIntermediaryLoaderPlugin.FABRIC_SERVER.getLevel(this.dimension()) != null;
    }
}
