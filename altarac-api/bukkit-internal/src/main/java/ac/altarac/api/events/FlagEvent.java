...
import ac.altarac.api.event.events.VerboseSuppliers;
...
public class FlagEvent extends Event implements AltarACUserEvent, Cancellable {

    private static final HandlerList handlers = new HandlerList();
    @Getter private final AltarACUser user;
