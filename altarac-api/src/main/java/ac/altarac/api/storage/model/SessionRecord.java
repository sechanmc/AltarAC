 ...
 * <p>
 * {@code serverName}, {@code AltarACVersion}, {@code serverVersionString},
...
public record SessionRecord(
        ...
        @Value @Nullable                                       String AltarACVersion,
    ...
    public SessionRecord(
        ...
        this(sessionId, playerUuid, serverName, startedEpochMs, lastActivityEpochMs,
                ...
                AltarACVersion, clientBrand, clientVersion, serverVersionString, null, null, sessionBlobs);
    }
    ...
    public SessionRecord(
        ...
        this(sessionId, playerUuid, serverName, startedEpochMs, lastActivityEpochMs, closedAtEpochMs,
                AltarACVersion, clientBrand, clientVersion, serverVersionString, instanceId, null, sessionBlobs);
    }
