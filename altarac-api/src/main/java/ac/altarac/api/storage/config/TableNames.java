package ac.altarac.api.storage.config;
 ...
 * <p>
 * Lives as a field on each concrete {@link ac.altarac.api.storage.backend.BackendConfig}
 * so an operator can rename any of them (to share a DB with another plugin, to
 * match a corporate naming scheme, to keep two AltarAC instances side-by-side in
 ...
 *       table name. Defaults are {@code AltarAC_meta}, {@code AltarAC_checks},
 *       {@code AltarAC_players}, {@code AltarAC_sessions}, {@code AltarAC_violations},
 *       {@code AltarAC_settings}.</li>
 ...
 *       building keys (e.g. {@code AltarAC_violations:<sessionId>}). Operators
 *       who prefer colon-namespaced Redis keys can set values like
 *       {@code AltarAC:violations}; nothing in this record forbids colons.</li>
 * </ul>
 * <p>
 ...
 * collections / keys first, or run {@code /AltarAC history copy} from a backend
 ...
 *
 * @deprecated Replaced by {@link ac.altarac.api.storage.registry.StoreRegistry} +
 * {@link ac.altarac.api.storage.registry.StoreId}. Instead of a fixed six-slot
...
public record TableNames(
    ...
    public static final String DEFAULT_META = "AltarAC_meta";
    public static final String DEFAULT_CHECKS = "AltarAC_checks";
    public static final String DEFAULT_PLAYERS = "AltarAC_players";
    public static final String DEFAULT_SESSIONS = "AltarAC_sessions";
    public static final String DEFAULT_VIOLATIONS = "AltarAC_violations";
    public static final String DEFAULT_SETTINGS = "AltarAC_settings";
    ...
    /**
     * Read the six names from a {@link ac.altarac.api.storage.backend.BackendConfigSource}
    ...
    public static @NotNull TableNames readFrom(
            @NotNull ac.altarac.api.storage.backend.BackendConfigSource source) {
