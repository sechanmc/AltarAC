package ac.altarac.api.storage.query;
 ...
 *
 * @deprecated Replaced by {@link ac.altarac.api.storage.kind.Operation} plus the
 * per-Kind operation menus on {@link ac.altarac.api.storage.category.EventStreamCategory},
 * {@link ac.altarac.api.storage.category.EntityCategory}, etc. The redesign moves
