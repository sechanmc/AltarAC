...
import ac.altarac.api.handler.UserHandlerHolder;
import org.jetbrains.annotations.Nullable;

import java.util.Collection;
import java.util.UUID;

public interface AltarACUser extends ConfigReloadable, BasicReloadable, UserHandlerHolder, AltarACIdentity {
     ...
     * This needs to be executed on the player's netty thread. You can use {@link AltarACUser#runSafely(Runnable)} to ensure this.
     *
