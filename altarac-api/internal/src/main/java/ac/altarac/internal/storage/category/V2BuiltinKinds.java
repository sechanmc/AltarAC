...
import ac.altarac.api.storage.codec.FieldKind;
import ac.altarac.api.storage.codec.MergeMode;
import ac.altarac.api.storage.kind.Entity;
import ac.altarac.api.storage.kind.EventStream;
import ac.altarac.api.storage.kind.Granularity;
import ac.altarac.api.storage.kind.IndexSpec;
...
import ac.altarac.api.storage.model.ServerInstanceRecord;
...
import ac.altarac.internal.storage.codec.MethodHandleCodecFactory;
...
/**
 * Static {@link ac.altarac.api.storage.kind.DataKind} declarations for
...
public final class V2BuiltinKinds {
     ...
     *       {@code /AltarAC history} session list ordering for one player.</li>
     ...
     * {@code current_name_lower} index for /AltarAC history's by-name lookup.
     ...
     *       {@code /AltarAC instances} admin listing grouped by display
     *       label.</li>
     * </ul>
