package ac.altarac.internal.storage.backend.postgres.v2;

import ac.altarac.api.storage.backend.ApiVersion;
import ac.altarac.api.storage.backend.AdminAdapter;
...
import ac.altarac.api.storage.backend.SearchAdapter;
import ac.altarac.api.storage.backend.TxAdapter;
...
import ac.altarac.internal.storage.backend.sql.v2.SqlEntityAdapter;
import ac.altarac.internal.storage.backend.sql.v2.dialect.PostgresDialect;
import ac.altarac.internal.storage.backend.sql.v2.dialect.SqlDialect;
...
public final class PostgresBackendV2 implements BackendV2 {
    ...
    private static final String POOL_NAME = "AltarAC-postgres-v2";
    ...
    private ac.altarac.internal.storage.backend.sql.v2.SqlEventStreamAdapter eventStreamAdapter;
    private ac.altarac.internal.storage.backend.sql.v2.SqlKeyValueScopedAdapter kvScopedAdapter;
    private ac.altarac.internal.storage.backend.sql.v2.SqlCounterAdapter counterAdapter;
    ...
    @Override
    public int writerThreads(@NotNull ac.altarac.api.storage.category.Category<?> category) {
    ...
    public void init(@NotNull BackendContext ctx) throws BackendException {
        ...
        this.eventStreamAdapter = new ac.altarac.internal.storage.backend.sql.v2.SqlEventStreamAdapter(ds, dialect, logger);
        this.kvScopedAdapter = new ac.altarac.internal.storage.backend.sql.v2.SqlKeyValueScopedAdapter(ds, dialect, logger);
        this.counterAdapter = new ac.altarac.internal.storage.backend.sql.v2.SqlCounterAdapter(ds, dialect, logger);
    }
