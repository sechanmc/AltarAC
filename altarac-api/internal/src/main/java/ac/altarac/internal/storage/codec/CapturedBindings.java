 ...
 * class-init from a resource ({@value #RESOURCE}) baked into {@code AltarAC-internal}
 ...
 * un-obfuscated jars and for extension jars that AltarAC's obfuscator never
 * touches.
 */
@ApiStatus.Internal
public final class CapturedBindings {
    ...
    static final String RESOURCE = "/META-INF/AltarAC/codec-bindings.tsv";
