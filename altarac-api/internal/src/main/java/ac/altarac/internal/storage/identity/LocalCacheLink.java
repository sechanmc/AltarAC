package ac.altarac.internal.storage.identity;
 ...
 * legacy {@link ac.altarac.api.storage.query.Query} into the
 * equivalent v2 {@link ac.altarac.api.storage.kind.Operation} and
