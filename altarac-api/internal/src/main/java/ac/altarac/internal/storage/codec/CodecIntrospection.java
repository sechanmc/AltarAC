package ac.altarac.internal.storage.codec;

import ac.altarac.api.storage.codec.EncodeShape;
import ac.altarac.api.storage.codec.EncodeShape.FieldDef;
...
import ac.altarac.api.storage.codec.InsertOnly;
...
import ac.altarac.api.storage.codec.Partition;
import ac.altarac.api.storage.codec.Persistent;
import ac.altarac.api.storage.codec.PreserveOnNonNull;
import ac.altarac.api.storage.codec.SearchType;
import ac.altarac.api.storage.codec.Searchable;
import ac.altarac.api.storage.codec.Sentinel;
import ac.altarac.api.storage.codec.Timestamp;
import ac.altarac.api.storage.codec.Transient;
