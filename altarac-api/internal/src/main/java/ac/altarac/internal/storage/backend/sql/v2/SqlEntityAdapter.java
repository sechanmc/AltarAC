package ac.altarac.internal.storage.backend.sql.v2;
...
import ac.altarac.api.storage.query.Cursors;
...
import ac.altarac.internal.storage.codec.bson.BsonCodec;
import ac.altarac.internal.storage.codec.bson.BsonCodecs;
 ...
 * {@link ac.altarac.api.storage.codec.MergeMode}:
 * <ul>
 ...
 * all five modes.
 *
 * <p>{@link ac.altarac.api.storage.codec.Sentinel @Sentinel}
...
public final class SqlEntityAdapter implements KindAdapter<Entity<?, ?, ?>> {
    ...
    private static @NotNull EncodeShape.FieldDef stringFieldDef() {
        ...
        return new EncodeShape.FieldDef("__prefix__", String.class,
            ac.altarac.api.storage.codec.FieldKind.VALUE, false, null, 0, 0);
    }
