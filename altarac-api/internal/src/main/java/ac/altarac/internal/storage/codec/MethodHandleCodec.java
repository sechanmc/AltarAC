...
public class MethodHandleCodec<R> implements Codec<R> {
    ...
    private static @NotNull MethodHandle canonicalConstructorHandle(
        ...
        // Record canonical constructors are public; AltarAC-internal's own lookup
     ...
     * {@link ac.altarac.api.storage.codec.MergeMode#PRESERVE_ON_NON_SENTINEL}
    ...
    public @Nullable Object requireFieldOrDefault(int i, @Nullable Object value) {
        ...
        if (def.mergeMode() == ac.altarac.api.storage.codec.MergeMode.PRESERVE_ON_NON_SENTINEL) {
