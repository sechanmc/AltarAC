package ac.altarac.internal.storage.backend.mysql.v2;
...
import ac.altarac.internal.storage.backend.sql.v2.dialect.MysqlDialect;
...
public final class MysqlBackendV2 implements BackendV2 {
    ...
    @Override public int writerThreads(@NotNull ac.altarac.api.storage.category.Category<?> category) {
    ...
    public void init(@NotNull BackendContext ctx) throws BackendException {
        ...
        hc.setPoolName("AltarAC-mysql-v2");
