package ac.altarac.internal.storage.instance;
...
public final class HeartbeatScheduler {
    ...
    private final @Nullable String AltarACVersion;
    ...
    public HeartbeatScheduler(
        ...
        this(startupId, instanceId, serverName, startedEpochMs, hostname,
                AltarACVersion, serverVersionString, (byte[]) null, interval, publish, logger);
    }
    ...
    public HeartbeatScheduler(
            ...
            @NotNull Logger logger) {
        this(startupId, instanceId, serverName, startedEpochMs, hostname,
                AltarACVersion, serverVersionString, () -> verboseManifest, interval, publish, logger);
    }
    ...
    public HeartbeatScheduler(
        ...
        this.AltarACVersion = AltarACVersion;
    ...
    public void start() {
        synchronized (lifecycleLock) {
            ...
            executor = Executors.newSingleThreadScheduledExecutor(r -> {
                Thread t = new Thread(r, "AltarAC-storage-heartbeat-" + serverName);
                t.setDaemon(true);
                schedulerThread = t;
                return t;
            });
