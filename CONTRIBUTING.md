# Contributing to AltarAC

Thank you for your interest in contributing to AltarAC. This document outlines the guidelines for
making pull
...
- **Compatibility**
  ...
  the [supported environments](https://github.com/AltarAC/AltarAC/wiki/Supported-environments) (Spigot, Paper, Folia, Fabric, etc.)
...
- AltarAC is built using [Gradle](https://gradle.org/) kotlin scripts.
- Java 21 is currently required to build the project. A minimum of Java 17 is required to run it.

### Questions & Support

- Join our [Discord](https://discord.AltarAC.ac) if you have questions or need assistance.
- Refer to the [Wiki](https://github.com/AltarAC/AltarAC/wiki) for project documentation.
