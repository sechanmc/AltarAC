...
public class BukkitPermissionRegistrationManager implements PermissionRegistrationManager {
     ...
     * like "AltarAC.exempt.checkname") that are generated at runtime. Most other static permissions
     * (e.g., "AltarAC.exempt", "AltarAC.alerts.enable-on-join") are registered with their defaults
     ...
     *
     * @param name         The permission node to register (e.g., "AltarAC.exempt.checkname").
