package ac.altarac.platform.bukkit.player;
...
import ac.altarac.platform.bukkit.utils.anticheat.MultiLibUtil;
import ac.altarac.platform.bukkit.utils.convert.BukkitConversionUtils;
...
public class BukkitPlatformPlayer extends BukkitAltarACEntity implements PlatformPlayer {

    private static final BukkitAudiences audiences = BukkitAudiences.create(AltarACBukkitLoaderPlugin.LOADER);
    ...
    @Override
    public @Nullable AltarACEntity getVehicle() {
        return bukkitPlayer.getVehicle() == null ? null : new BukkitAltarACEntity(bukkitPlayer.getVehicle());
    }
    ...
    public void sendPluginMessage(String channelName, byte[] byteArray) {
        this.bukkitPlayer.sendPluginMessage(AltarACBukkitLoaderPlugin.LOADER, channelName, byteArray);
    }

    @Override
    public Sender getSender() {
        return AltarACBukkitLoaderPlugin.LOADER.getBukkitSenderFactory().map(this.bukkitPlayer);
    }
